...
public struct RGBAColor: Equatable, Codable, Hashable {
    ...
    /// Quick-pick presets shown as swatches, laid out 11 per row × 4 rows (any
    ...
    public static let palette: [RGBAColor] = [
        ...
        RGBAColor(r: 0.80, g: 0.90, b: 0.20),   // chartreuse
        .lime, .green,
        RGBAColor(r: 0.10, g: 0.78, b: 0.55),   // emerald
        .teal, .cyan,
        RGBAColor(r: 0.25, g: 0.65, b: 0.98),   // sky
        // Row 2 — blues → purples → warm pinks
        .blue,
        ...
        RGBAColor(r: 0.98, g: 0.50, b: 0.45),   // coral
        RGBAColor(r: 0.99, g: 0.65, b: 0.55),   // salmon
        RGBAColor(r: 0.99, g: 0.80, b: 0.68),   // peach
        RGBAColor(r: 0.85, g: 0.68, b: 0.22),   // gold
        // Row 3 — deep / muted
        RGBAColor(r: 0.55, g: 0.12, b: 0.16),   // maroon
        RGBAColor(r: 0.70, g: 0.30, b: 0.12),   // rust
        RGBAColor(r: 0.45, g: 0.30, b: 0.20),   // brown
        ...
        RGBAColor(r: 0.45, g: 0.10, b: 0.28),   // wine
        RGBAColor(r: 0.30, g: 0.35, b: 0.55),   // slate blue
        ...
        RGBAColor(r: 0.98, g: 0.95, b: 0.85),   // cream
        .white,
        RGBAColor(r: 0.76, g: 0.78, b: 0.81),   // light gray
        RGBAColor(r: 0.50, g: 0.52, b: 0.55),   // gray
        RGBAColor(r: 0.35, g: 0.40, b: 0.46),   // slate
        RGBAColor(r: 0.20, g: 0.22, b: 0.26),   // charcoal
        RGBAColor(r: 0.08, g: 0.09, b: 0.11),   // near black
        RGBAColor(r: 0, g: 0, b: 0),            // black
    ]
}
